##### my packages ################################################################################
## CRAN
cran.packages <- c('ggplot2','gridExtra','viridis','plyr','reshape2')
...
dir.bio  <- 'data/bio/'                 # dir to store carbio + length-fres 
...
dir.rdat <- paste0(dir.rdat,max(my.year),'/')             # Rdata by year
